...
urlpatterns = [
    ...
    path('sensors/<int:sensor_id>/predictions/', sensor_predicted_list, name='sensor-predicted-list'),
    path('sensors/<int:sensor_id>/predictions/<int:pk>/', sensor_predicted_detail, name='sensor-predicted-detail'),
]
